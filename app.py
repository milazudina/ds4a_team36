...
def construct_dashboard():
    st.subheader('Explore the data science job market')
...
def contruct_about():
    st.subheader('About the Pathfinder')
    ...
    description = 'We developed the Pathfinder application to identify your skill gaps and make auto-suggestions for career transition and promotion in data science related jobs.'
    st.write(description)
    description = 'Source code and installation instructions of the applicaition are available on our project github repository: milazudina/ds4a_team36.'
    st.write(description)    
...
def main():
    ...
    st.title('Pathfinder: Identify Your Data Science Career Path')
